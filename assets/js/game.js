class Game {
	constructor() {
		...
		//Maakt een HUD voor de score & randen.
		this.hud = new Hud(this);

		//Kijkt welke key word gedrukt voor de bewegingen.
		this.keys = [];
		...
		//Checkt dat er een key word losgelaten.
	...
	//Checkt de snelheid van de spelers en bal
	...
	//Checkt als de bal iets raakt en verandert de velocity
